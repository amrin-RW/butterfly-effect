...
var import_react, isSSR, useIsomorphicLayoutEffect;
var init_esm = __esm({
  "node_modules/zustand/esm/index.js"() {
...
var globalCache, suspend, preload, clear;
var init_dist = __esm({
  "node_modules/suspend-react/dist/index.js"() {
    globalCache = [];
    suspend = (fn, keys2, config) => query(fn, keys2, false, config);
    preload = (fn, keys2, config) => void query(fn, keys2, true, config);
    clear = (keys2) => {
    ...
    for (const hit of hits) {
      ...
      while (eventObject) {
        ...
        if ((_r3f2 = eventObject.__r3f) != null && _r3f2.eventCount)
          intersections.push(__spreadProps(__spreadValues({}, hit), {
            eventObject
          }));
  ...
  return {
    configure(props = {}) {
      ...
      if (!is.equ(options, raycaster, shallowLoose))
        applyProps(raycaster, __spreadValues({}, options));
      ...
      if (!state.xr) {
        ...
        const handleSessionChange = () => {
          ...
          gl2.xr.enabled = gl2.xr.isPresenting;
          gl2.xr.setAnimationLoop(gl2.xr.isPresenting ? handleXRFrame : null);
        };
        const xr = {
          connect() {
            const gl2 = store.getState().gl;
...
var React, import_constants, import_react_reconciler, import_scheduler, threeTypes, isOrthographicCamera, isSSR2, useIsomorphicLayoutEffect2, ErrorBoundary, DEFAULT, isDiffSet, getRootState, is, INDEX_REGEX, catalogue, extend, privateKeys, isRenderer, context, createStore2, i, globalEffects, globalAfterEffects, globalTailEffects, addEffect, addAfterEffect, addTail, subscribers, subscription, roots, invalidate, advance, reconciler, applyProps, shallowLoose, createRendererInstance, act;
var init_index_bfdbf5d7_esm = __esm({
  "node_modules/@react-three/fiber/dist/index-bfdbf5d7.esm.js"() {
    init_three_module();
    ...
    init_dist();
    threeTypes = Object.freeze({
      __proto__: null
    });
    isOrthographicCamera = (def) => def && def.isOrthographicCamera;
    isSSR2 = typeof window === "undefined" || !window.navigator || /ServerSideRendering|^Deno\//.test(window.navigator.userAgent);
    useIsomorphicLayoutEffect2 = isSSR2 ? React.useEffect : React.useLayoutEffect;
    ...
    INDEX_REGEX = /-\d+$/;
    catalogue = {};
    extend = (objects) => void (catalogue = __spreadValues(__spreadValues({}, catalogue), objects));
    ...
    globalAfterEffects = [];
    globalTailEffects = [];
    addEffect = (callback) => createSubs(callback, globalEffects);
    addAfterEffect = (callback) => createSubs(callback, globalAfterEffects);
    addTail = (callback) => createSubs(callback, globalTailEffects);
    ...
    createRendererInstance = (gl, canvas) => {
      ...
      if (isRenderer(customRenderer))
        ...
        return new WebGLRenderer(__spreadValues({
...
var import_react2, import_debounce, keys, areBoundsEqual;
var init_web = __esm({
  "node_modules/react-use-measure/dist/web.js"() {
    import_react2 = __toESM(require_react());
    import_debounce = __toESM(require_debounce());
    keys = ["x", "y", "top", "bottom", "left", "right", "width", "height"];
    areBoundsEqual = (a, b) => keys.every((key) => a[key] === b[key]);
  }
});
...
var React2, import_constants2, import_react_reconciler2, import_scheduler2, DOM_EVENTS, Canvas;
var init_react_three_fiber_esm = __esm({
  "node_modules/@react-three/fiber/dist/react-three-fiber.esm.js"() {
    init_index_bfdbf5d7_esm();
    init_index_bfdbf5d7_esm();
    init_extends();
    ...
    init_esm();
    import_react_reconciler2 = __toESM(require_react_reconciler());
    import_scheduler2 = __toESM(require_scheduler2());
    init_dist();
    DOM_EVENTS = {
      onClick: ["click", false],
    ...
    Canvas = React2.forwardRef(function Canvas2(_a, forwardedRef) {
      var _b = _a, {
        children,
        fallback,
        resize,
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-OH7PINCL.js.map
